...
//		driver = base.loadChromeDriver();
	...
	public void Creating_new_General_Ledger(Hashtable<String, String> testData) throws InterruptedException, AWTException {
		/*
		 * STEP 1
		...
		/*
		 * STEP 4
		 * enter GL account (1238-01-20) and click on Yes to create new record
		 */
		driver.findElement(By.id(prop.getProperty("GL_AC_page_GLAccount_Input"))).sendKeys(testData.get("GLAccount"),Keys.TAB);
		base.waitfor(3000);
		 ...
		 * Click on save button on toolbar and Duplicate Entry pop up appears
		 * Click on Yes
		 */
